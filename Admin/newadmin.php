...
if (isset($_POST['querysubmit'])) {
    ...
    $sql = 'SELECT MAX(id) AS lastid FROM user WHERE user_type = "admin"';
    ...
    mysqli_query($db_conn, "INSERT INTO user (id, user_type, firstname, lastname, email, password, address, city, country, phone, genderid) VALUES ('$id', '$type', '$firstname', '$lastname', '$email', '$password', '$address', '$city', '$country', '$phone', '$gender');") or die("Admin Table error");
          ...
          <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 2xl:col-span-3" >
            ...
            <div class="mb-4 flex items-center justify-between">
              ...
              <div class="flex-shrink-0">
                <a href="index.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg p-2">All Admins</a>
              </div>
            </div>
