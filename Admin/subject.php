...
if (isset($_POST['delete'])) {
    $id = $_POST['delete'];
    mysqli_query($db_conn, "DELETE FROM subject WHERE subject.id = $id;") or die("Deletion depatment not possible");
}
?>
...
if (isset($_POST['querysubmit'])) {
    ...
    $sql = 'SELECT MAX(id) AS lastid FROM subject WHERE subject.departmentid = '.$dept.'';
    ...
    mysqli_query($db_conn, "INSERT INTO subject (id, name, departmentid) VALUES ('$id', '$sec', '$dept');") or die("Insertion Error");
                    ...
                    <div class="min-w-full align-middle">
                        <div class="shadow">
                            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <?php
                                $extract_user_query = 'SELECT * FROM subject';
                    ...
                    <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <form action="" method="POST">
                            <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3 xl:col-span-6">
                                        <label for="subjectname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subject name</label>
                                        <input type="text" name="subject" id="subjectname" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. Computer Engineering" required="">
                                    </div>
                                    <div class="col-span-6 sm:col-span-3 xl:col-span-6">
